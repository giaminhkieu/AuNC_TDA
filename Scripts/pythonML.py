...
target_variable = "mu"
model_name = "010823_3stream_" + target_variable
...
for test_index in range(len(x1)):
  ...
  input = Concatenate()([dense_1_extra, dense_3, input3])
...
size = len(y)
print(80*"-")
print("3-Stream input model with EarlyStopping,", target_variable)
print(80*"-")
print("Model structure: ")
print("5,5,3 || (16,3,3), (2,2), (16,3,3), (2,2), flatten, 32, 16 || 1 || 64,1")
print("Hyperparameters: ")
print("Epochs: 500, ES = 40 patience Opt: Adam (MAE), LR: 0.001, batch size: 24")
