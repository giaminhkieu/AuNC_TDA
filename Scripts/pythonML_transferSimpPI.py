...
target_variable = "mu"
model_name = "010823_transferSimpPI_" + target_variable
...
for test_index in range(len(x1)):
  ...
  input = Concatenate()([dense_1_extra, flatten])
...
size = len(y)
print(80*"-")
print("Model: simp+PI input CNN with tranfer learning,", target_variable)
print(80*"-")
print("Hyperparameters: Opt: Adam(MAE), lr = 0.001, batchsize=24, Epochs = 500, EarlyS=30, val_split = 15")
print("Structure: 5,5,1 || TF [:-2] || NA || 64,16,1")
print(80*"-")
